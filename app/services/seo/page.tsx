...
import Link from 'next/link'
  ...
  const features = [
    ...
    const industries = ['E-commerce', 'Local Services', 'Blogs', 'Real Estate', 'Education']

     const  convincingMessage =  "94% of users never click past the first page of Google. Get on page one or stay invisible. It's that simple."
 ...
 <section id="contact" className="relative w-full overflow-hidden" style={{ 
      background: 'transparent',
          ...
          <div className="absolute inset-0 bg-cover bg-center bg-no-repeat"
               style={{ 
                 backgroundImage: "url('/seo-banner.jpg')",
               }}>
                 {/* Dark Overlay */}
              ...
              <FadeUp>
                <div className="text-center mb-12">
                  <h2 className="text-3xl md:text-4xl font-bold text-[#17012C] mb-3">
                    Let Build Your Digital <span className="text-[#F39F5F]">Presence .</span>
                  </h2>
                  ...
                  <div className="rounded-2xl p-6 md:p-8 mb-12">
                    <div className="flex flex-col lg:flex-row gap-8">
                      ...
                      <div className="flex-1">
                        <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4" style={{ color: "#219BE6" }}>
                            ...
                            <ul className="space-y-2">
                              {features.map((feature, idx) => (
                                <li key={idx} className="text-sm text-[#555555] flex items-start gap-2">
                                  <span className="mt-0.5" style={{ color: "#219BE6" }}>▸</span>
                                  {feature}
                                </li>
                              ))}
                            </ul>
                      ...
                      <div className="lg:w-96">
                        <div className="rounded-xl p-6 text-center relative overflow-hidden" style={{ backgroundColor: `"#219BE6"/10`,  boxShadow: `0 8px 25px {"#219BE6"}/15` }}>
                          <div className="relative z-10">
                            <h4 className="font-bold text-lg mb-4">Industries We Serve</h4>
                            <div className="flex flex-wrap gap-2 justify-center mb-6">
                              {industries.map((industry, idx) => (
                                <span key={idx} className="px-3 py-1.5 rounded-full text-xs md:text-sm font-medium" style={{ backgroundColor: `"#219BE6"/10`, color: "#219BE6", border: `1px solid {"#219BE6"}/15` }}>
                                  {industry}
                                </span>
                              ))}
                            </div>
                        ...
                        {convincingMessage}
                            ...
                            <Link href="/contact">
                              <button className="w-[80%] py-3 text-white font-semibold rounded-sm transition-all duration-300 hover:scale-105" style={{ backgroundColor: "#219BE6" }}>
                                Get Started →
                              </button>
                            </Link>
                          </div>
