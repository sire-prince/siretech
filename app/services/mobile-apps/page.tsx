...
const features = [
    ...
    const industries = ['Logistics', 'Retail', 'Food Delivery', 'Banking', 'Health Tech', 'Education', 'Real Estate', 'Religious Organizations', 'Startups', 'Corporate']
        const convincingMessage = "85% of Ghanaians access the internet via mobile. Don't miss out on this massive market - put your business in their pocket."
 ...
 const benefits = [
  ...
  const projects = [
  {
    ...
    description: "Complete mobile app store with inventory management, payment integration, and customer analytics.",
    challenge: "No online presence and manual order management",
    solution: "Full-featured e-commerce platform with payment integration",
  ...
  {
    id: 4,
    title: "SME Business Suite",
    category: "business",
    industry: "Business",
    service: "web-development",
    description: "From managing customer relationships to tracking projects and handling finances, we provide the digital heartbeat of your company. It's the simplicity of a small business tool with the power of an enterprise suite.",
    challenge: "Disconnected business tools and manual processes",
    solution: "All-in-one business management platform",
    results: "60% operational efficiency, centralized business data",
    technologies: ["Next.js", "Express", "PostgreSQL", "Paystack"],
    icon: "🏪",
    duration: "3 weeks",
    client: "SME Growth Hub"
  },
  {
    id: 5,
    ...
    industry: "Technology",
    service: "web-development",
    description: "An agile, API-first management platform built for the startup lifecycle. This custom application prioritizes data liquidity and automation, featuring a dynamic dashboard for real-time KPI tracking and automated workflow triggers.",
    challenge: "Fragmented data and slow decision-making",
    solution: "Unified dashboard with automated KPI tracking and workflows",
    results: "40% faster decision-making, automated reporting",
  ...
  },
  {
    ...
    industry: "Education",
    service: "web-development",
    description: "A complete digital solution for educational institutions that transforms traditional classrooms into high-performance learning networks with student management, fee tracking, exam management, and parent portals.",
    challenge: "Manual record keeping and parent-teacher communication gaps",
    solution: "Centralized platform with real-time updates and parent engagement",
    results: "70% reduction in admin work, improved parent satisfaction",
    technologies: ["Next.js", "Node.js", "PostgreSQL", "Paystack"],
    icon: "🎓",
    duration: "3 weeks",
    client: "Premier Schools Group"
  }
];
const services = [
    {
 ...
 <section id="contact" className="relative w-full overflow-hidden" style={{ 
      background: 'transparent',
          ...
          <div className="absolute inset-0 bg-cover bg-center bg-no-repeat"
               style={{ 
                 backgroundImage: "url('/app-banner.jpeg')",
               }}>
                 {/* Dark Overlay */}
          <div className="absolute inset-0" style={{ 
            ...
            {/* Content */}
                     ...
                     <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 mb-3">
                        ...
                        We Help Rank Your Business For<br /> Your Clients Outreach </h1>
                        </FadeDown>
                      </div>
                  ...
                  <div className="rounded-2xl p-6 md:p-8 mb-12">
                    <div className="flex flex-col lg:flex-row gap-8">
                      ...
                      <div className="flex-1">
                        <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4" style={{ color: "#5B3AEE" }}>
                            ...
                            <ul className="space-y-2">
                              {features.map((feature, idx) => (
                                <li key={idx} className="text-sm text-[#555555] flex items-start gap-2">
                                  <span className="mt-0.5" style={{ color: "#5B3AEE" }}>▸</span>
                                  {feature}
                                </li>
                              ))}
                            </ul>
                      ...
                      <div className="lg:w-96">
                        <div className="rounded-xl p-6 text-center relative overflow-hidden" style={{ backgroundColor: `"#5B3AEE"/10`,  boxShadow: `0 8px 25px {"#5B3AEE"}/15` }}>
                          <div className="relative z-10">
                            <h4 className="font-bold text-lg mb-4">Industries We Serve</h4>
                            <div className="flex flex-wrap gap-2 justify-center mb-6">
                              {industries.map((industry, idx) => (
                                <span key={idx} className="px-3 py-1.5 rounded-full text-xs md:text-sm font-medium" style={{ backgroundColor: `"#5B3AEE"/10`, color: "#5B3AEE", border: `1px solid {"#5B3AEE"}/15` }}>
                                  {industry}
                                </span>
                              ))}
                            </div>
                        ...
                        {convincingMessage}
                            ...
                            <Link href="/contact">
                              <button className="w-[80%] py-3 text-white font-semibold rounded-sm transition-all duration-300 hover:scale-105" style={{ backgroundColor: "#5B3AEE" }}>
                                Get Started →
                              </button>
                            </Link>
                          </div>
