...
import Link from 'next/link'
 ...
 const industries = ['All Industries']
   ...
   const benefits =[
        ...
        const convincingMessage = "Don't let a hacked or slow website destroy your reputation. Get enterprise-grade security and performance."
 ...
 <section id="contact" className="relative w-full overflow-hidden" style={{ 
      background: 'transparent',
          ...
          <div className="absolute inset-0 bg-cover bg-center bg-no-repeat"
               style={{ 
                 backgroundImage: "url('/maint-banner.png')",
               }}>
                 {/* Dark Overlay */}
                ...
                <div className="text-center mb-10">
                  <div className="flex flex-wrap items-center justify-center gap-3 mb-6">
                    {["", "Web Development", "ECommerce", "SEO", "Brand Design", "App Development", "Graphic Design", "Website Maintenance", ""].map((tag, index) => (
                      <span 
                        key={index}
                        className="px-4 py-2 rounded-full bg-[#EAF3F8] border border-[#17012C]/20 text-[#17012C] text-sm font-medium hover:border-[#F39F5F]/40 hover:bg-[#ECF8FF] transition-all duration-300 hover:scale-105"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <div className="rounded-2xl p-6 md:p-8 mb-12">
                    <div className="flex flex-col lg:flex-row gap-8">
                      ...
                      <div className="flex-1">
                        <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4" style={{ color: "#17012C" }}>
                            ...
                            <ul className="space-y-2">
                              {features.map((feature, idx) => (
                                <li key={idx} className="text-sm text-[#555555] flex items-start gap-2">
                                  <span className="mt-0.5" style={{ color: "#17012C" }}>▸</span>
                                  {feature}
                                </li>
                              ))}
                            </ul>
                      ...
                      <div className="lg:w-96">
                        <div className="rounded-xl p-6 text-center relative overflow-hidden" style={{ backgroundColor: `"#17012C"/10`,  boxShadow: `0 8px 25px {"#17012C"}/15` }}>
                          <div className="relative z-10">
                            <h4 className="font-bold text-lg mb-4">Industries We Serve</h4>
                            <div className="flex flex-wrap gap-2 justify-center mb-6">
                              {industries.map((industry, idx) => (
                                <span key={idx} className="px-3 py-1.5 rounded-full text-xs md:text-sm font-medium" style={{ backgroundColor: `"#17012C"/10`, color: "#17012C", border: `1px solid {"#17012C"}/15` }}>
                                  {industry}
                                </span>
                              ))}
                            </div>
                        ...
                        {convincingMessage}
                            ...
                            <Link href="/contact">
                              <button className="w-[80%] py-3 text-white font-semibold rounded-sm transition-all duration-300 hover:scale-105" style={{ backgroundColor: "#17012C" }}>
                                Get Started →
                              </button>
                            </Link>
                          </div>
