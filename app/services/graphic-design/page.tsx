...
const  industries = ['Retail', 'Hospitality', 'Media', 'Corporate', 'Startups']
    const  features = [
      ...
      const  convincingMessage = "Your brand is your promise to your customer. Make it memorable, make it professional, make it yours."
  const projects = [
       {
      id: 1,
 ...
 <section id="contact" className="relative w-full overflow-hidden" style={{ 
      background: 'transparent',
          ...
          <div className="absolute inset-0 bg-cover bg-center bg-no-repeat"
               style={{ 
                 backgroundImage: "url('/graphic-banner.png')",
               }}>
                 {/* Dark Overlay */}
          <div className="absolute inset-0" style={{ 
            ...
            {/* Content */}
                     ...
                     <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 mb-3">
                        ...
                        Have The Best Graphic Design Services .</h1>
                        </FadeDown>
                      </div>
              ...
              <FadeUp>
                <div className="text-center mb-12">
                  <h2 className="text-3xl md:text-4xl font-bold mb-3">
                    Communicate Your<span className="text-[#F39F5F]"> Business Today</span>
                  </h2>
                ...
                <div className="text-center mb-10">
                  <div className="flex flex-wrap items-center justify-center gap-3 mb-6">
                    {["", "Web Development", "ECommerce", "SEO", "Brand Design", "App Development", "Graphic Design", "Website Maintenance", ""].map((tag, index) => (
                      <span 
                        key={index}
                        className="px-4 py-2 rounded-full bg-[#EAF3F8] border border-[#5B3AEE]/20 text-[#00A9CE] text-sm font-medium hover:border-[#F39F5F]/40 hover:bg-[#ECF8FF] transition-all duration-300 hover:scale-105"
                      >
                        {tag}
                      </span>
                    ))}
        ...
        <FadeUp>
                  <div className="rounded-2xl p-6 md:p-8 mb-12">
                    <div className="flex flex-col lg:flex-row gap-8">
                      ...
                      <div className="flex-1">
                        <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4" style={{ color: "#00A9CE" }}>
                          Graphic Design 
                        </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                          <div>
                            <h4 className="font-semibold text-[#00A9CE] mb-3">Key Features</h4>
                            <ul className="space-y-2">
                              {features.map((feature, idx) => (
                                <li key={idx} className="text-sm text-[#555555] flex items-start gap-2">
                                  <span className="mt-0.5" style={{ color: "#00A9CE" }}>▸</span>
                                  {feature}
                                </li>
                              ))}
                            </ul>
                          ...
                          <div>
                            <h4 className="font-semibold text-[#00A9CE] mb-3">How We Help Businesses</h4>
                            <ul className="space-y-2">
                      ...
                      <div className="lg:w-96">
                        <div className="rounded-xl p-6 text-center relative overflow-hidden" style={{ backgroundColor: `"#00A9CE"/10`,  boxShadow: `0 8px 25px {"#00A9CE"}/15` }}>
                          <div className="relative z-10">
                            <h4 className="font-bold text-lg mb-4">Industries We Serve</h4>
                            <div className="flex flex-wrap gap-2 justify-center mb-6">
                              {industries.map((industry, idx) => (
                                <span key={idx} className="px-3 py-1.5 rounded-full text-xs md:text-sm font-medium" style={{ backgroundColor: `"#00A9CE"/10`, color: "#00A9CE", border: `1px solid {"#00A9CE"}/15` }}>
                                  {industry}
                                </span>
                              ))}
                            </div>
                        ...
                        {convincingMessage}
                            ...
                            <Link href="/contact">
                              <button className="w-[80%] py-3 text-white font-semibold rounded-sm transition-all duration-300 hover:scale-105" style={{ backgroundColor: "#00A9CE" }}>
                                Get Started →
                              </button>
                            </Link>
                          </div>
              ...
              <FadeUp delay={0.3}>
                <div className="text-center my-16 p-8 bg-gradient-to-r from-[#F39F5F]/10 to-[#219BE4]/10 rounded-2xl">
                  <p className="text-[#00A9CE] font-bold mb-2">Have a project in mind ?</p>
